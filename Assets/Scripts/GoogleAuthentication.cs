...
// Método para acionar o login no navegador via JavaScript
[System.Runtime.InteropServices.DllImport("__Internal")]
private static extern void SignInWithGoogle();

public void OnGoogleSignInWebGL(string jsonData)
{
    // Parse JSON data (substitua isso por sua lógica)
    GoogleSignInUser user = JsonUtility.FromJson<GoogleSignInUser>(jsonData);

    // Atualize o UI
    StartCoroutine(UpdateUI(user));
}
